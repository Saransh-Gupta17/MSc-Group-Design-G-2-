...
%% Calculate Cabin Radius and Diameter
[ADP.CabinLength,ADP.CabinRadius] = B777.geom.fuselage_sizer(ADP.Fleet_size, ADP.Pallet_size, ADP.CockpitLength, ADP.D_max);
%ADP.CabinRadius = 3.1;
